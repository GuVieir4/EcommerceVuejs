...
<template>
  <section>
    ...
    <div @click="irParaDetalhes" class="card-produto group bg-[#f6f6f6] rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out overflow-hidden cursor-pointer flex flex-col h-full relative">
      ...
      <div class="p-4 pt-10 relative">
        <img :src="produto.image" :alt="produto.title" class="w-full h-48 object-contain group-hover:scale-105 transition-transform duration-300 ease-in-out mb-4">
      </div>
      ...
      <div class="p-4 flex flex-col flex-grow">
        ...
        <button class="bg-[#000] rounded-[8px] gap-[8px] flex justify-center items-center py-2 px-4 mt-2 text-gray-100">Add to Cart</button>
      </div>
    </div>
  </section>
</template>
